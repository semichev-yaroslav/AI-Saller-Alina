...
class HeuristicLeadAnalyzer:
    ...
    def _build_reply(self, intent: IntentType, services: list[dict[str, str]]) -> str:
        ...
        if intent == IntentType.SERVICE_QUESTION:
            ...
            return f"Мы можем предложить: {listed}. Какая бизнес-задача у вас сейчас в приоритете?"
        ...
        if intent == IntentType.GREETING:
            return "Здравствуйте. Опишите вашу задачу, и я помогу подобрать подходящее AI-решение."
