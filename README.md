...
`AI Sales Manager` автоматически обрабатывает входящие сообщения клиентов (Telegram/API), определяет `intent`, стадию лида, генерирует ответ через LLM и сохраняет полную историю диалога.
...
- представляется как AI Sales Manager,
